...
namespace DeveloperConsole.Tests.EditMode.Integration
{
    public class ParserIntegrationTest
    {
        ...
        [Test]
        public void Parser_ShouldSucceed_WithMultipleArguments()
        {
        ...
        {
            List<string> tokens = new() { "--no-help", "-ab", "-p", "1", "0", "-no-a", "false", "filename", "--flag", "false", "freddo", "0", "-1", "0", "1" };
            TokenStream stream = new TokenStream(tokens);
            ...
            var commandType = new CommandBuilder()
                ...
                .WithSwitch("a", typeof(bool))
                .WithSwitch("b", typeof(bool))
