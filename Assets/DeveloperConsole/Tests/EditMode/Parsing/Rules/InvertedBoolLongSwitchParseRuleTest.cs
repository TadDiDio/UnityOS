...
namespace DeveloperConsole.Tests.Parsing.Rules
{
    public class InvertedBoolLongSwitchParseRuleTest
    {
        ...
        public void Filter_ShouldMatch()
        {
            ...
            var result = rule.Filter("--no-flag", allArgs, null);
        ...
        [Test]
        public void Filter_ShouldReturnNull_WhenFlagDoesntStartWithNo()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
        ...
        public void Filter_ShouldReturnNull_WhenFlagDoesntMatchName()
        {
            ...
            var result = rule.Filter("--no-flags", allArgs, null);
            
            Assert.IsNull(result);
        }
        
        [Test]
        public void Filter_ShouldReturnNull_WhenFlagIsOnlyNoAndDashes()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
            ...
            var result = rule.Filter("--no-", allArgs, null);
        ...
        [Test]
        public void Apply_ShouldSucceedReturnFalse_WhenBoolIsTrue()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
            ...
            List<string> tokens = new() { "--no-flag", "true" };
        ...
        [Test]
        public void Apply_ShouldSucceedReturnTrue_WhenBoolIsFalse()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
            ...
            List<string> tokens = new() { "--no-flag", "false" };
            TokenStream stream = new TokenStream(tokens);
        ...
        [Test]
        public void Apply_ShouldSucceedReturnFalse_WhenBoolIsImplied()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
            ...
            List<string> tokens = new() { "--no-flag" };
            TokenStream stream = new TokenStream(tokens);
        ...
        [Test]
        public void Apply_ShouldSucceedReturnFalse_WhenBoolIsImpliedWithAnotherToken()
        {
            var field = new FieldBuilder()
                .WithName("flag")
                .WithType(typeof(bool))
            ...
            List<string> tokens = new() { "--no-flag", "token" };
            TokenStream stream = new TokenStream(tokens);
